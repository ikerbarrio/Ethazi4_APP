...
>>>>>>> branch 'master' of https://github.com/ikerbarrio/Ethazi4_APP.git
				...
				if (temporada.equals("alta")) {
					...
					try {
						c.setTime(dateFormat.parse(strDateHasiera));
						c.add(Calendar.DATE, 1);
						String gaurkoData = dateFormat.format(c.getTime());
						Date biharkoData = dateFormat.parse(gaurkoData);
						amaieraDateChooser.setSelectableDateRange(biharkoData, null);
